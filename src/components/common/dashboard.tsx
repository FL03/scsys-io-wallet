...
> = ({ ref, className, children, panel, asChild, classes = {}, ...props }) => {
  ...
  return (
    <Comp
      ...
      ref={ref}
      className={cn(
        'flex flex-1 flex-wrap overflow-hidden h-full w-full',
        'gap-4 lg:gap-6 mt-2 lg:mt-4',
        className
      )}
    >
      {/* Secondary */}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'gap-4 lg:gap-6',
        'rounded-2xl shadow-inner drop-shadow-2xl',
        'bg-background/95 border-none text-foreground',
        className
      )}
    />
  );
...
> = ({ ref, className, asChild, withSecondary, side = 'right', ...props }) => {
  ...
  return (
    <Comp
      ...
      ref={ref}
      className={cn(
        'flex flex-col flex-1 h-full w-full overflow-hidden gap-4 lg:gap-6',
        side && `${side}-0`,
        withSecondary && 'md:max-w-md',
        className
      )}
    />
  );
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'gap-4 lg:gap-6 h-fit lg:h-full w-full lg:max-w-sm',
        className
      )}
    />
  );
